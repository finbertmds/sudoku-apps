import {
  ...
  AD_UNIT_REWARDED_INTERSTITIAL_IOS,
} from '@env';
import {Platform} from 'react-native';
import {TestIds} from 'react-native-google-mobile-ads';

type AdType = 'banner' | 'interstitial' | 'rewarded' | 'rewardedInterstitial';
...
const PROD_AD_UNITS_IOS: Record<AdType, string> = {
  ...
  rewarded: AD_UNIT_REWARDED_INTERSTITIAL_IOS,
  rewardedInterstitial: AD_UNIT_REWARDED_INTERSTITIAL_IOS,
};

const PROD_AD_UNITS_ANDROID: Record<AdType, string> = {
  banner: AD_UNIT_BANNER_ANDROID,
  interstitial: AD_UNIT_INTERSTITIAL_ANDROID,
  rewarded: AD_UNIT_REWARDED_INTERSTITIAL_ANDROID,
  rewardedInterstitial: AD_UNIT_REWARDED_INTERSTITIAL_ANDROID,
};
